...
--
-- Estrutura para tabela `cardápio_itens`
--

CREATE TABLE `cardápio_itens` (
  `ID` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `cardápio_itens`
--

INSERT INTO `cardápio_itens` (`ID`, `TITULO`, `DESCRICAO`, `PRECO`, `POSSUI_PREPARO`) VALUES
(1, 'XIS SALADA', 'BIFE 180 G\r\nALFACE\r\nTOMATE\r\nQUEIJO CHEDDAR\r\nMAIONESE\r\nPÃO DE BRIOCHE', '23.90', 1),
(2, 'COCA COLA LATA ZERO 350ML', 'COCA COLA LATA ZERO 350ML', '6.50', 0);
...
(2, 'Gabriel Kappenberg', 'kappenberg4@gmail.com', '1215');
...
--
-- Índices de tabela `cardápio_itens`
--
ALTER TABLE `cardápio_itens`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT de tabela `cardápio_itens`
--
ALTER TABLE `cardápio_itens`
